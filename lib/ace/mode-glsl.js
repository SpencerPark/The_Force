...
var glslHighlightRules = function() {
    ...
    var headerFunctions = (
        ...
        "tile|tileC|rotateTile|translateTileContents|" +
        "circleTile|donutTile|boxTile|triSplitTile|regPolyTile|hexTile|truchetTile|" +
        "phasor|sinOsc|triOsc|sawOsc|sqrOsc|" +
        "sSinOsc|sTriOsc|sSawOsc|sSqrOsc|" +
        "prallelLine|hline|vline|"
        );
